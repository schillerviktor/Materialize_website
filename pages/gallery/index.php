...
<section>
    ...
    <div class="row">
        <article class="col m12 gallery-section">
			...
			* Csak bejelentkezett felhasználók tudnak képet feltölteni! - Only registered Users can upload pictures!
			</article>
			<?php endif; ?>
            <?php if ($logged_in): ?>
			<div class="upload-images">
                <form action="/?page=gallery&action=upload" method="post" enctype="multipart/form-data">
                    ...
                    <input type="submit" class="btn blue-grey" value="Fájlok feltöltése" name="submit">
                </form>
            </div>
            <?php endif; ?>
			<div class="row">
